    ...
    items.forEach(item => {
      ...
      let mk = L.marker([Number(item.lat), Number(item.lng)], {
        ...
        '<p><span style="font-size: 24px;">ข้อมูลร้านค้า</span></p>' +
          '<span style="font-size: 16px;"><b>ชื่อร้าน:</b>' +
          item.storename +
          "</span><br>" +
          '<span style="font-size: 16px;"><b>เลขทะเบียนการค้า:</b>' +
          item.storeid +
          "</span><br>" +
          '<span style="font-size: 16px;"><b>facebook:</b>' +
          item.facebook +
          "</span><br>" +
          '<span style="font-size: 16px;"><b>Line:</b>' +
          item.lineid +
          "</span><br>" +
          '<span style="font-size: 16px;"><b>โทรศัพท์:</b>' +
          item.tel +
          "</span><br>" +
          '<span style="font-size: 16px;"><b>จำนวนหน้ากาก:</b>' +
          item.maskvol +
          " </span><br>" +
          '<span style="font-size: 16px;"><b>ราคาต่ำสุด:</b>' +
          item.masklowprice +
          " " +
          " บาท <b>ราคาสูงสุด:</b>" +
          item.maskhighprice +
          " บาท</span><br>" +
          '<span style="font-size: 16px;"><b>จำนวนเจลล้างมือ:</b>' +
          item.gelvol +
          " </span><br>" +
          '<span style="font-size: 16px;"><b>ราคาต่ำสุด:</b>' +
          item.gellowprice +
...
function selectStore(km) {
  ...
  $.get(
    "http://localhost/mapedia.serv/_getallstore.php?lat=" +
      gps._latlng.lat +
      "&lng=" +
      gps._latlng.lng +
      "&buf=" +
    ...
    data.forEach(i => {
      console.log(i);
      const $newStore = $(
        '<div class="card"><div class="card-body">ร้าน: ' +
          i.storename +
          " มีหน้ากาก:" +
          i.maskvol +
          " มีเจลล้างมือ:" +
          i.gelvol +
          "&nbsp;&nbsp;" +
          '<br><a class="btn btn-outline-info" onclick="zoomStore(\'' +
          i.lat +
          "," +
          i.lng +
          "')\" >ตำแหน่งร้าน</a>" +
          '&nbsp;<a class="btn btn-outline-info" href="https://www.google.com/maps/dir/' +
          gps._latlng.lat +
          "," +
          gps._latlng.lng +
          "/" +
          ...
          "," +
          Number(i.lng) +
          '/data=!3m1!4b1!4m2!4m1!3e0">เส้นทาง</a>' +
          "</div></div>"
      );
